...
Kullanım:
    python training/train_task1.py --weights models/task1/2025_best.pt --data data/datasets/task1/dataset_2026.yaml
"""
...
def parse_args():
    ...
    # EKLENDİ: 2025'te elde edilen en iyi model ağırlıkları
    p.add_argument('--weights', default='models/task1/2025_best.pt', 
...
def main():
    ...
    # En iyi modeli models/task1/ klasörüne kopyala
    best = Path(f'runs/task1/{args.model}_teknofest_2026_finetune/weights/best.pt')
    if best.exists():
        dst = Path(f'models/task1/{args.model}_2026_best.pt')
